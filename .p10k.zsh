# Generated by Powerlevel10k configuration wizard on 2022-07-24 at 13:00 IST.
...
() {
  ...
  # Right prompt on the last prompt line (where you are typing your comxwnds) gets
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # time-warrior          # timewarrior tracking status (https://timewarrior.net/)
